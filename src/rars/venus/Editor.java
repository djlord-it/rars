...
public class Editor {
    ...
    public Editor(VenusUI ui) {
        ...
        newUsageCount = 0;
        // Use user home directory as default. Guaranteed to have a value.
        defaultOpenDirectory = System.getProperty("user.home");
        defaultSaveDirectory = System.getProperty("user.home");
